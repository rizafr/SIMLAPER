...
# Database: simlaper
# Generation Time: 2017-04-14 06:29:08 +0000
# ************************************************************
...
INSERT INTO `disposisi` (`id_disposisi`, `id_surat_masuk`, `kode_intruksi`, `isi_instruksi`, `tgl_instruksi`, `batas_waktu`, `waktu_lama_instruksi`, `paraf_kasi`, `paraf_kajari`, `tujuan_disposisi`, `tgl_disposisi`, `catatan`, `lampiran_foto`, `lampiran_dokumen`, `tgl_laporan`)
VALUES
...
# Dump of table pelaksanaan_intruksi
# ------------------------------------------------------------
...
INSERT INTO `pelaksanaan_intruksi` (`id`, `kode_intruksi`, `intruksi`)
VALUES
	(1,'1','UDK'),
	(2,'1','Saya Hadir'),
	(3,'2','Hadiri'),
...
INSERT INTO `pengguna` (`id_pengguna`, `username`, `password`, `nama`, `nip`, `jabatan`, `id_level`)
VALUES
	(1,'admin','21232f297a57a5a743894a0e4a801fc3','IYAN SUKMANA, S.IP','19741202 200701 1 00','Administrator',1),
...
INSERT INTO `pengirim` (`id_pengirim`, `instansi`)
VALUES
	(1,'WALIKOTA CIMAHI'),
...
INSERT INTO `perkara` (`id_perkara`, `no_agenda`, `tanggal_perkara`, `nama_tersangka`, `perkara`, `id_jaksa`)
VALUES
...
INSERT INTO `ref_disposisi` (`id`, `tujuan_disposisi`)
VALUES
...
INSERT INTO `ref_klasifikasi` (`id`, `kode`, `nama`, `uraian`)
VALUES
...
INSERT INTO `ref_sifat_surat` (`id`, `deskripsi`)
VALUES
	(1,'Biasa'),
	(2,'Penting'),
	(3,'Rahasia'),
...
INSERT INTO `surat_masuk` (`id_surat_masuk`, `kode_surat_masuk`, `no_surat_masuk`, `asal_surat_masuk`, `tgl_surat_masuk`, `status_surat_masuk`, `perihal_surat_masuk`, `tgl_penyelesaian`, `no_agenda`, `lampiran`, `tgl_diterima`, `pengolah`, `keterangan`, `status_disposisi`)
VALUES
...
INSERT INTO `t_aplikasi` (`id`, `name`, `desc`, `projectName`, `developedBy`)
VALUES
	(1,'.:: SIMLAPER ::.','.:: SIMLAPER ::.','Proyek Perubahan Diklatpim IV - Iyan','Developed by Riza Fauzi Rahman dan Ismail');
...
INSERT INTO `tr_instansi` (`id`, `nama`, `alamat`, `kepsek`, `nip_kepsek`, `logo`)
VALUES
