...
<div class="well">
    ...
    <form action="<?php echo base_URL(); ?>kader/index/<?php echo $act; ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="right mt25">
                    <a href="<?php echo base_URL(); ?>kader/index" class="btn btn-success">
