				...
				<div class="container">
					...
					<div class="navbar-collapse collapse navbar-inverse-collapse" style="margin-right: -20px">
						<ul class="nav navbar-nav">
							<li>
								<a href="<?php echo base_URL(); ?>pasien/index/add" class="btn-info"><i
						...
						if (empty($data)) {
							...
							<tr>
								...
								<?php 
									...
									<td class="ctr">
										<div class="btn-group">
											<a href="<?php echo base_URL(); ?>pasien/index/edt/<?php echo $b->id; ?>" class="btn btn-success btn-sm"><i class="icon-edit icon-white"> </i> Edit</a>
											<a href="<?php echo base_URL() ?>pasien/index/del/<?php echo $b->id ?>"
